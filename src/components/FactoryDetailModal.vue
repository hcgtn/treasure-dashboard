    ...
    <div class="modal-content modal-lg">
      ...
      <div class="modal-body" v-if="factory">
        ...
        <div class="score-section">
          <water-level-pond :config="waterLevelConfig" style="width:170px;height:170px" />
        </div>
          ...
          <div class="asset-card">
            <div class="asset-icon">
              <svg width="28" height="26" viewBox="0 0 28 26">
                <polygon points="14,0 28,26 0,26" fill="#00e676" />
              </svg>
            </div>
...
const waterLevelConfig = computed(() => ({
  data: [factory.value?.creditScore || 0],
  shape: 'round',
  waveColor: scoreColor.value,
  borderColor: scoreColor.value,
  colors: [ scoreColor.value, scoreColor.value],
  borderWidth: 2,
  waveNum: 3,
  formatter: `{value}分\n${factory.value?.creditLevel || ''}级`
}))
